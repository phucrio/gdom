...
The app header and browser favicon use this same SVG. All packaged desktop icons in `src-tauri/icons/` are generated from it, including Windows ICO, macOS ICNS, PNG sizes, and the Square/Store logos. Keeping ICNS assets does not add macOS runtime support.
