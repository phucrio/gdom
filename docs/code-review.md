...
- [ ] **Canary Before Bulk**: Initial Start transfer approval covers the selected job. The quick flow may continue to remaining items only after every selected canary item is verified. Failed or incomplete canaries retain review; another queued job requires its own start. Do not reintroduce recipient re-entry or a second approval for successful remaining transfers.
